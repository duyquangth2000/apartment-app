...
import objToArr from "../../ultils/Common/abjToArr";
      ...
      <div className="w-[70%]">
        ...
        <div className="bg-white rounded-md shadow-md p-4"> 
          <div className="flex flex-col gap-2">
            <h2 className="text-x1 font-bold text-red-600 my-4">
              {posts[0]?.title}
            </h2>
          ...
          <div className="mt-8">
            <h3 className="font-semibold text-x1 my-4">Thông tin mô tả</h3>
          ...
          <div className="mt-8">
            <h3 className="font-semibold text-x1 my-4">Đặc điểm tin đăng</h3>
          ...
          <div className="mt-8">
            <h3 className="font-semibold text-x1 my-4">Thông tin liên hệ</h3>
            <table className="w-full">
              <tbody className="w-full">
                <tr className="w-full">
