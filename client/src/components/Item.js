...
const { GrStar, RiHeartFill, RiHeartLine, BsBookmarkStarFill, SiZalo } = icons
            ...
            <div className='w-3/5'>
                ...
                <div className='flex items-center my-5 justify-between'>
                    ...
                    <div className='flex items-center gap-0.5'>
                        ...
                        <a className="bg-blue py-2 flex items-center justify-center gap-2 w-full rounded-md font-bold text-lg" href={`https://zalo.me/${user?.zalo}`}>
                            <span className='bg-blue-600 text-white rounded-md p-3 hover:bg-blue-400'>Zalo</span>
                        </a> 
