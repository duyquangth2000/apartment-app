...
const BoxInfo = ({ userData }) => {
    return (
        <div className="w-full bg-yellow-500 rounded-md flex flex-col items-center p-4 gap-4">
            ...
            <h3 className="font-medium text-x1">{userData?.name}</h3>
            ...
            <a className="bg-white py-2 flex items-center justify-center gap-2 w-full rounded-md font-bold text-lg hover:bg-blue-100" href={`https://zalo.me/${userData?.zalo}`}>
